...
export const Header = () => {
  ...
  return (
    ...
    >
      ...
      <nav className="text-gray-800 dark:text-foreground hidden text-xl md:text-lg sm:block">
          ...
          {links.map(({ name, hash }) => (
            <li key={name}>
              ...
              >
                ...
                {name === activeSection && (
                  <motion.span
                    className="bg-blue-500 text-white absolute inset-0 -z-10 rounded-full"
